...
from networksequrity.entity.artifact_entity import DataTransformationArtifact,ModelTrainerArtifact
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        ## Track the experiements with mlflow( ussed to track the entire life cycle of an ML project)
        self.track_mlflow(best_model,classification_train_metric)


        y_test_pred=best_model.predict(x_test)
        classification_test_metric=get_classification_score(y_true=y_test,y_pred=y_test_pred)
        # mlflow for test metrics
